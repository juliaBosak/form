...
<script>
	...
	export default {
		...
		methods: {
			checkForm: function () {
				this.reset = false;
				if (!this.isFirstNameValid) this.isFirstNameTouched = true;
				if (!this.isEmailValid) this.isEmailTouched = true;
				if (!this.countrySelected) this.isCountryTouched = true;
				if (!this.isPhoneNumberValid) this.isPhoneNumberTouched = true;
				if (!this.isLastNameValid) this.isLastNameTouched = true;
				if (!this.isUserIDValid) this.isUserIDTouched = true;
				if (!this.isReferenceCodeValid) this.isReferenceCodeTouched = true;
				if (!this.stateSelected) this.isStateTouched = true;
				if (!this.citySelected) this.isCityTouched = true;
			},
			resetForm: function () {
